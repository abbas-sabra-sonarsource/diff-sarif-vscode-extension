// RUN: %clang_analyze_cc1 -analyzer-checker=core,alpha.security.taint,debug.TaintTest,unix.Malloc %s -verify -analyzer-output=sarif -o %t.sarif
#include "system-header-simulator.h"
#include "system-header-simulator-for-malloc.h"
#define ERR -1
